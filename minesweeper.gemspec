...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Minesweeper library to create minesweeper games.'
  spec.homepage      = 'https://bitbucket.org/joaobertacchi/minesweeper'
  spec.license       = 'MIT'
  ...
  spec.add_runtime_dependency 'yard-contracts', '~> 0.1'
end
